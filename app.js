...
app.use(express.static(path.join(__dirname, "Devvelopper")));

// Serve the index.html file at the root URL
app.get("/", (req, res) => {
  res.sendFile(path.join(__dirname, "Devvelopper", "index.html"));
});
...
app.get("/payment", (req, res) => {
  res.sendFile(path.join(__dirname, "Devvelopper", "payment.html"));
});
